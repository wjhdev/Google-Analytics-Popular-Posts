...
function analyticbridge_network_option_page_html() {
  ...
  echo '<form action="' .
    admin_url('admin-post.php?action=network-analytic-bridge-options') .
    '" method="post">';
  ...
  echo '<input name="analyticbridge_network_setting_api_client_id" id="analyticbridge_network_setting_api_client_id" type="text" value="' .
    get_site_option('analyticbridge_network_setting_api_client_id') .
    '" class="regular-text" />';
  echo "</td></tr><tr><th scope='row'>Client Secret</th><td>";
  echo '<input name="analyticbridge_network_setting_api_client_secret" id="analyticbridge_network_setting_api_client_secret" type="text" value="' .
    get_site_option('analyticbridge_network_setting_api_client_secret') .
    '" class="regular-text" />';
  echo '</tbody></table>';
...
function analyticbridge_update_network_options() {
  ...
  update_site_option(
    'analyticbridge_network_setting_api_client_id',
    $_POST['analyticbridge_network_setting_api_client_id']
  );
  update_site_option(
    'analyticbridge_network_setting_api_client_secret',
    $_POST['analyticbridge_network_setting_api_client_secret']
  );
